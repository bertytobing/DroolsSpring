...
public class BusPassApp {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(BusPassApp.class, args);
        /*
         * String[] beanNames = ctx.getBeanDefinitionNames(); Arrays.sort(beanNames);
         * 
         * StringBuilder sb = new StringBuilder("Application beans:\n"); for (String beanName :
         * beanNames) { sb.append(beanName + "\n"); } log.info(sb.toString());
         */
    }

    /**
     * By defining the {@link KieContainer} as a bean here, we ensure that Drools will hunt out the
     * kmodule.xml and rules on application startup. Those can be found in
